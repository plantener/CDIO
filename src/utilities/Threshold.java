...
public enum Threshold {
	GREEN_LOWER (38 ,80,70 ), GREEN_UPPER (60 ,255,255), 
	YELLOW_LOWER(75 ,60 ,60 ), YELLOW_UPPER(100,255,255), //teal
	BLUE_LOWER  (102,55 ,60 ), BLUE_UPPER  (115,255,255),
	PURPLE_LOWER(130,70 ,70 ), PURPLE_UPPER(165,255,255),
	RED_LOWER   (167,100,75 ), RED_UPPER   (180,255,255);

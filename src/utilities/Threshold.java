...
//	YELLOW_LOWER(30,80,140), YELLOW_UPPER(40,255,255),
//	BLUE_LOWER(95,120,100), BLUE_UPPER(115,255,255),
//	PURPLE_LOWER(135,100,100), PURPLE_UPPER(155,255,255);
	
	//Updated thresholds for lab
	GREEN_LOWER(40,70,75), GREEN_UPPER(75,255,255), 
	RED_LOWER(165,70,75), RED_UPPER(180,255,255),
	YELLOW_LOWER(30,100,110), YELLOW_UPPER(38,255,255),
	BLUE_LOWER(105,78,75), BLUE_UPPER(125,255,255),
	PURPLE_LOWER(135,78,75), PURPLE_UPPER(155,255,255);
